<template>
  <div class="app-container">
    ...
    <passwordSetting v-if="isPasswordSet" @close="closePasswordSetting" @upData="getRoleUserList" :roleMsg="settingObj"></passwordSetting>
    <switchSetting v-if="isSwitch" @close="closeSwitchSetting" @upData="getRoleUserList" :roleMsg="settingObj"></switchSetting>
  </div>
</template>
