...
<script>
  ...
  import newGov from '@/views/operationRole/userManagement/serviceGovernor/components/newGov'
  import accountMessage from '@/views/operationRole/userManagement/serviceGovernor/components/accountMessage'
  import serviceManageSuccess from '@/views/operationRole/userManagement/serviceGovernor/components/serviceManageSuccess'
  import {
    getRoleUserList
