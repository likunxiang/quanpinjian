<template>
  <el-dialog title="账号信息管理" :visible.sync="isOpen" width="1000px" @close="beforeClose">
...
<script>
  ...
  import delPop from '@/views/operationRole/userManagement/serviceGovernor/components/delPop'
