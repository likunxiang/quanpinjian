          ...
          <el-col :span="12">
            <el-form-item label="状态" prop="status">
              <el-radio-group v-model="ruleForm.status">
                <el-radio v-for="dict in statusList" :key="dict.value" :label="dict.value">
                  {{dict.label}}
                </el-radio>
              </el-radio-group>
            </el-form-item>
  ...
  export default {
    ...
    data() {
      return {
        ...
        ruleForm: {
          nickName: '',
          deptId: '1e1841c2-040e-11ed-b3e9-00163e2ca549',
          password: '',
          name: '',
          userTel: '',
          status: '0'
    ...
    methods: {
      ...
      async getUserDetail() {
        ...
        getUserDetail({
          ...
          this.ruleForm.roleKey = 'customerServiceRole',
          ...
          this.oldForm.roleKey = 'customerServiceRole',
