    ...
    <el-table :data="tableList" border v-loading="loading">
      ...
      <el-table-column label="操作" align="center">
        <template slot-scope="scope">
          ...
          <!-- <el-row>
            <el-button type="text" @click="toSuccess(scope.row)">引导主管成果</el-button>
          </el-row> -->
        </template>
      </el-table-column>
    </el-table>
...
<script>
  ...
  import newGov from '@/views/operationRole/userManagement/guideGovernor/components/newGov'
  import accountMessage from '@/views/operationRole/userManagement/guideGovernor/components/accountMessage'
