<template>
	<div class="app-container">
		...
		<el-table v-loading="loading" :data="tableData" border style="width: 100%">
			<el-table-column prop="categoryName" label="品类名称" align="center" width="200">
			</el-table-column>
			...
			<el-table-column label="操作" align="center">
				<template slot-scope="scope">
					<el-row>
						<el-button @click="setting(scope.row)" type="text" size="small">节点交易设置</el-button>
					</el-row>
					<el-row>
						<el-button @click="release(scope.row)" type="text" size="small"
							:disabled="scope.row.publishFlag==2">发布</el-button>
					</el-row>
				</template>
			</el-table-column>
		</el-table>
...
<script>
	...
	import tradeSetting from '@/views/modelRole/transactionRules/components/tradeSetting.vue'
