		...
		<el-row class="mt20">
			<el-tabs v-model="activeName" type="card" @tab-click="handleClick">
				<el-tab-pane label="采购需求信息配置" name="demand" v-if="openRow.bizType == '1'">
					<el-tree :data="demandList" node-key="id" v-loading="loading" :props="defaultProps"
						@node-drag-start="handleDragStart" @node-drag-enter="handleDragEnter" @node-expand="getSon"
				...
				<el-tab-pane label="供应需求信息配置" name="supply" v-if="openRow.bizType == '1'">
					<el-tree :data="demandList" v-loading="loading" @node-expand="getSon" :props="defaultProps"
