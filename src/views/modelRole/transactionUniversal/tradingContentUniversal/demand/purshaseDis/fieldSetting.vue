<template>
  <div class="app-container" v-if="loading">
    ...
    <contentSources v-if="isContentFrom" :categoryName="openRow.categoryName" :fieldObj="tableData[0]"
      @close="closeContentFrom" @refresh="getPlateFieldContents" :bizType="this.openRow.bizType" :isUniversal="true"></contentSources>

    <!-- 需方操作设置 -->
    <userOperation v-if="isDemander" :type="openRow.catTreeCode" :categoryName="openRow.categoryName" :fieldObj="tableData[0]"
      @close="closeDemander" @refresh="getPlateFieldContents" :bizType="this.openRow.bizType" :isUniversal="true"></userOperation>

    <!-- 字段内容管理 -->
    <fieldContentManagement v-if="isFieldMessage" :type="openRow.catTreeCode" :categoryName="openRow.categoryName"
      :fieldObj="tableData[0]" @close="closeFieldMessage" @refresh="getPlateFieldContents" :bizType="this.openRow.bizType" :isUniversal="true"></fieldContentManagement>
  </div>
</template>
