<template>
	<div class="page">
		<div class="flex flex-center mb20">
			<el-input placeholder="请输入你要查找的采购编号" prefix-icon clearable v-model="searchVal" @keyup.enter.native="search"
		...
		<findingResultNotSys v-if="isFinding" @close="closeFindingDetail" :row="openRow"
			@refresh='getNonSysWaitJudgeList'></findingResultNotSys>
