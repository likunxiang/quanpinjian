	...
	<el-dialog title="结算管理" :visible.sync="isOpen" width="900px" @close="beforeClose">
		...
		<el-tabs v-model="activeName" type="card" @tab-click="handleClick">
			<el-tab-pane label="未结算" name="first">
				...
				<el-row style="padding-bottom: 60px;">
					<el-table :data="tableData" border height="50vh" v-loading="loading">
						<el-table-column prop="judgeTime" label="裁决结果日期" align="center" width="100">
						</el-table-column>
						<el-table-column prop="name" label="账单编号" align="center" width="100">
						</el-table-column>
						...
						<el-table-column prop="disobeyFee" label="结算金额" align="center" width="100">
						</el-table-column>
						<el-table-column label="采购情况" align="center" width="100" fixed="right">
						...
						<el-table-column label="裁决情况" align="center" width="100" fixed="right">
							<template slot-scope="scope">
								<el-row>
						...
						<el-table-column label="供应情况" align="center" width="100" fixed="right">
							<template slot-scope="scope">
								<el-row>
						...
						<el-table-column label="结算操作" align="center" width="100" fixed="right">
							<template slot-scope="scope">
								<el-row>
									<el-button type="text" @click="confirmPenalty(scope.row)">确认处罚收取</el-button>
								</el-row>
							</template>
						</el-table-column>
					</el-table>
			...
			<el-tab-pane label="已结算" name="second">
				...
				<el-row style="padding-bottom: 60px;">
					<el-table :data="tableData" border height="50vh" v-loading="loading">
						<el-table-column prop="confirmPayTime" label="确认处罚收取日期" align="center" width="100">
						</el-table-column>
						<el-table-column prop="judgeTime" label="裁决结果日期" align="center" width="100">
						</el-table-column>
						<el-table-column prop="categoryName" label="品类名称" align="center" width="100">
		...
		<!-- 申请账号信息 end -->
		<confirmPenaltyPop v-if="isConfirm" @close="closeConfirmPenalty" :row="openRow" @refresh="getUnPayListByMonth">
		</confirmPenaltyPop>
