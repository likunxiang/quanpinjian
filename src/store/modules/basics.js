const basics = {
  state: {
    ...
    img_url_ord: process.env.VUE_APP_BASE_URL_ASSETS + '/Enclosure/APRC/ORDER/IMAGES/',  // 订单相关图片文件夹(成果、退款、验收证明等)
    img_url_user_feedback_user: process.env.VUE_APP_BASE_URL_ASSETS + '/Enclosure/APRC/USER/USE_FEEDBACK/IMAGES/',  // 工具使用意见反馈图片文件夹
    img_url_user_feedback_order: process.env.VUE_APP_BASE_URL_ASSETS + '/Enclosure/APRC/USER/ORDER_FEEDBACK/IMAGES/',  // 退货退款异常反馈图片文件夹
    ...
    img_url_servicefee: process.env.VUE_APP_BASE_URL_ASSETS + '/Enclosure/APRC/SERVICEFEE/MN/IMAGES/', // 定价专员-按型号名称-定价说明图片上传文件夹
